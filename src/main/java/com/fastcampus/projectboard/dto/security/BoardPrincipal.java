...
public record BoardPrincipal(
    ...
    @Override public Collection<? extends GrantedAuthority> getAuthorities() { return authorities; } //권한
    ...
    // OAuth2User getAttributes / getName
    @Override
    public Map<String, Object> getAttributes() { // OAuth2(kakao,naver ..)에서 내려 받은 인증자 정보
